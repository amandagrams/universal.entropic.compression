...
namespace universal.entropic.compression.Menu
{
    class AliceDecodeGolomb : Page
    {
        ...
        public override void Display()
        {
            ...
            //golomb.Decode(documents.ReadAllBytes(Utils.Utils.FilesEncoded.GolombEncodeAlice, false));
            ...
            Output.WriteLine(System.ConsoleColor.Green, "View the file encoded in: " + Utils.Utils.FilesDecoded.GolombDecodeAlice.ToString());
